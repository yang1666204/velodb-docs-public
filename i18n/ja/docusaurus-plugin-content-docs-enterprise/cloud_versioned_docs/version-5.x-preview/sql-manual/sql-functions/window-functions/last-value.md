...
| ------------------- | ----------------------------------------------------------------------------------------------------------- |
| expr                | 最後の値を取得する式。サポートされる型: tinyint/smallint/int/bigint/float/double/decimal/string/date/datetime/array/struct/map/bitmap                                                             |
| ignore_null         | オプションのBoolean型。設定時、null値は無視され、最後のnull以外の値が返される                              |
