...
+ target_table: 更新対象データのターゲットテーブル。'db_name.table_name'の形式で指定可能
...
+ FROM additional_tables: 更新する行を選択するため、または新しい値を設定するために使用する1つ以上のテーブルを指定します。ここでターゲットテーブルを使用したい場合は、明示的にエイリアスを与える必要があります。
