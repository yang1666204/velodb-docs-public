...
{
  "title": "Amazon S3",
  "description": "Dorisは、AWS S3からファイルを読み込む2つの方法を提供します：",
  "language": "ja"
}
---
Dorisは、AWS S3からファイルを読み込む2つの方法を提供します：
- S3 LoadでS3ファイルをDorisに読み込む方法。これは非同期読み込み方式です。
- TVFでS3ファイルをDorisに読み込む方法。これは同期読み込み方式です。
