...
{
  "title": "ジョブ",
  "description": "Table関数は、一時的なタスクTableを生成し、特定のタスクタイプのジョブ情報を表示することができます。",
  "language": "ja"
}
---
## 説明
...
| Field         | デスクリプション                                                                                   |
|---------------|-----------------------------------------------------------------------------------------------|
| **`<type>`**  | ジョブのタイプ: <br/> `insert`: Insert タイプジョブ。 <br/> `mv`: Materialized view ジョブ。 |
