---
{
  ...
  "description": "MILLISECONDSSUB関数は、入力された日時値から指定されたミリ秒数を減算し、結果として得られる新しい日時値を返します。",
  "language": "ja"
}
---
## 説明
...
|--------------|-----------------------------------------------------------------------------------------------|
| `<datetime>` | 入力するdatetime値で、`DATETIME`型です。具体的なdatetimeフォーマットについては、[datetime conversion](../../../../sql-manual/basic-element/sql-data-types/conversion/datetime-conversion)を参照してください。 |
