...
```
I'm ready to translate the English technical documentation into Japanese following your strict guidelines. However, I notice that the text you provided ends with "Example:" but doesn't include the actual content to be translated.

Could you please provide the complete text that needs to be translated?
