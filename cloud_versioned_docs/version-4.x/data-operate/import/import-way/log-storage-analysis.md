...
- For data partitioning:
    ...
    - Enable range partitioning (`PARTITION BY RANGE(`ts`)`) with dynamic partitions   (`"dynamic_partition.enable" = "true"`) managed automatically by day.
...
For more information, refer to Data Partitioning.
...
For more information about Kafka, see Routine Load.
