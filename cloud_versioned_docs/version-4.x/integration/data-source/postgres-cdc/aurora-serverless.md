---
{
    "title": "Aurora Serverless v2 PostgreSQL Source Setup",
    "language": "en",
    "description": "Aurora Serverless v2 PostgreSQL configuration for CDC synchronization with VeloDB using Flink CDC"
}
---
...
Once Aurora Serverless v2 is configured for CDC, follow the [Flink CDC Ingestion Guide](../postgres-cdc) to set up real-time sync to VeloDB.
