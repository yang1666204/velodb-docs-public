...
{
  "title": "IF",
  "description": "式 <condition> が true の場合、<valuetrue> を返します。そうでなければ、<valuefalseornull> を返します。",
  "language": "ja"
}
---
## 説明

式`<condition>`がtrueの場合、`<value_true>`を返します。そうでなければ、`<value_false_or_null>`を返します。
