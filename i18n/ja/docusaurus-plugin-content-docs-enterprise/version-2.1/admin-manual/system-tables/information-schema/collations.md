...
{
  "title": "collations",
  "description": "文字セットのすべての照合順序メソッドを表示します。このテーブルはMySQLの動作との互換性のためにのみ使用され、実用的な意味はありません。",
  "language": "ja"
}
---
## 概要

文字セットのすべての照合順序方式を表示します。このテーブルはMySQLの動作との互換性のためにのみ使用され、実用的な意味はありません。Dorisで実際に使用される文字照合順序方式を真に反映するものではありません。
