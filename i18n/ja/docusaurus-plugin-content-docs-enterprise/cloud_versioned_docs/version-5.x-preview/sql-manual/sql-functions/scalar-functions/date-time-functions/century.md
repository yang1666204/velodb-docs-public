...
{
  "title": "CENTURY",
  "description": "指定された日付の世紀を返します。入力が無効または サポート対象範囲外の場合、NULLを返します。",
  "language": "ja"
}
---
## Description  
指定された日付の世紀を返します。  
入力が無効または サポートされている範囲外の場合、NULLを返します。
...
| ------------- | ------------------------------------------------------------- |
| `<date_or_time_expr>` | 世紀を計算する対象の日付または日時式。 |

## Return Value
入力日付の世紀を表す整数（INT）を返します。例えば、1901年から2000年は20世紀に属します。入力がNULLまたは無効な日付の場合、NULLを返します。
