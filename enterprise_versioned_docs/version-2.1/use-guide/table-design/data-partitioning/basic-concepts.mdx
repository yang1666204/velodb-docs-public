---
{
    ...
    "language": "en",
    "description": "This document explains basic concepts of table creation and data partitioning in Apache Doris 2.1, including rows and columns, partition and bucket design, example CREATE TABLE syntax, and advanced features like auto partitioning and auto bucketing."
}
---
...
<div>
[Auto Partition](./auto-partitioning) supports automatic creation of corresponding partitions according to user-defined rules during data import.
