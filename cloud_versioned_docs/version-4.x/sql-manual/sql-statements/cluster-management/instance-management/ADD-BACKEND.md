...
2. Using Resource Group can help you better manage and organize the BE nodes in the cluster.
...
4. Add a BE node with public and private endpoints configured for complex network environments
   ...
   * `10.10.10.9:8020`: The private endpoint for VPC internal or Kubernetes cross-cluster access
   ...
   This configuration is useful in cloud environments or Kubernetes clusters where BE nodes need to be accessible from different network contexts. For more details, see Stream Load in Complex Network Environments.
