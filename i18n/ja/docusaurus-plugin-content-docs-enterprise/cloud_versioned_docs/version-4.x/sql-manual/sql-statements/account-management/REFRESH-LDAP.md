...
{
  "title": "LDAP を更新",
  "description": "この文はDorisのLDAPのキャッシュ情報を更新するために使用されます。",
  "language": "ja"
}
---
## Description
...
| 権限 | オブジェクト | 注記                 |
| :---------------- | :------------- | :---------------------------- |
| ADMIN_PRIV        | User または Role | `ADMIN_PRIV`権限を持つユーザーまたはロールのみが、すべてのユーザーのLDAPキャッシュ情報を更新できます。そうでない場合は、現在のユーザーのLDAPキャッシュ情報のみを更新できます |
...
- `user_name`が指定されない場合、現在のユーザーのLDAPキャッシュ情報が更新されます。
