---
{
  ...
  "description": "generator関数（EXPLODEなど）と組み合わせて使用し、1つ以上の行を含む仮想テーブルを生成します。",
  "language": "ja"
}
---
# Column to Row (Lateral View)

`EXPLODE`などのジェネレーター関数と組み合わせて使用し、1つまたは複数の行を含む仮想テーブルを生成します。`LATERAL VIEW`は各生の入力行に対して行を適用します。
