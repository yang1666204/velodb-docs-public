---
{
    "title": "BladePipe",
    "language": "en",
    "description": "BladePipe is a real-time end-to-end data replication tool, moving data between 30+ databases, message queues, search engines, caching, real-time data..."
}
---
