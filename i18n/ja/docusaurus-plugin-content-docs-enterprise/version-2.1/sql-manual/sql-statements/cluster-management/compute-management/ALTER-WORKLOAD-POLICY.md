---
{
  ...
  "description": "Workload Groupのプロパティを変更します。現在、プロパティの変更のみがサポートされています；",
  "language": "ja"
}
---
## 説明

Workload Groupのプロパティを変更します。現在、プロパティの変更のみがサポートされており、アクションや条件の変更はサポートされていません。
...
2. priority: 0から100の範囲の正の整数で、デフォルト値は0です。これはポリシーの優先度を表します。値が高いほど優先度が高くなります。このプロパティの主な役割は、複数のポリシーがマッチした場合に最も優先度の高いポリシーを選択することです。
