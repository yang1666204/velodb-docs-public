...
{
  "title": "YEAR_FLOOR",
  "description": "指定された日付を、指定した年間隔の開始点まで切り下げるために使用されます。複数のバリアントをサポートしています。",
  "language": "ja"
}
---
## デスクリプション
指定された年間隔の開始点まで、与えられた日付を切り下げるために使用されます。複数のバリアントをサポートしており、丸め処理を行うために開始時刻（origin）と期間（period）を異なる方法で指定できます。
