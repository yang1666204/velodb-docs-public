...
このステートメントは、1つまたは複数のBROKERノードを追加するために使用されます。
...
追加するbrokerプロセスに付与される名前です。同一クラスタ内ではbroker_nameを一致させることを推奨します。

**2. `<host>`**

brokerプロセスを追加する必要があるノードのIPです。FQDNが有効になっている場合は、ノードのFQDNを使用してください。
