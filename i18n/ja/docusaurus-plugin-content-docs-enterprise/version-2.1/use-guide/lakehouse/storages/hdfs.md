...
```
I'm ready to translate your technical documentation from English to Japanese following the rules you've specified. However, I notice that you've only provided "Example:" without the actual text content to translate.
