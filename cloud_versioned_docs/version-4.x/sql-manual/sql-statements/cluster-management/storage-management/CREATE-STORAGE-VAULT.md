...
2. Doris also support `AWS Assume Role` for S3 Vault(only for AWS S3 now), please refer to AWS intergration.
...
Doris also support `AWS Assume Role` for S3 Vault(only for AWS S3 now), please refer to AWS intergration
