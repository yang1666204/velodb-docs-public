...
{
  "title": "COUNT_BY_ENUM",
  "description": "列内のデータを列挙値として扱い、各列挙値の個数をカウントします。",
  "language": "ja"
}
---
## Description

列内のデータを列挙値として扱い、各列挙値の数をカウントします。各列の列挙値の数、および非NULL値の数とNULL値の数を返します。
...
| -- | -- |
| `<expr1>` | 少なくとも1つの入力が必要で、最大1024個の入力をサポートします。サポートされる型はStringです。 |
...
* cbe: 列挙値に基づく非NULL値の統計結果
* notnull: 非NULL値のカウント
* null: NULL値のカウント
* all: NULL値と非NULL値の両方を含む総カウント
