...
For more help, please refer to [ALTER USER](../../sql-manual/sql-statements/account-management/ALTER-USER).
...
- Revoke/Withdraw role: [REVOKE](../../sql-manual/sql-statements/account-management/REVOKE-FROM)
...
- View current user's permissions and roles: [SHOW GRANTS](../../sql-manual/sql-statements/account-management/SHOW-GRANTS)
- View all users' permissions and roles: [SHOW ALL GRANTS](../../sql-manual/sql-statements/account-management/SHOW-GRANTS)
- View created roles: [SHOW ROLES](../../sql-manual/sql-statements/account-management/SHOW-ROLES)
- Set user property: [SET PROPERTY](../../sql-manual/sql-statements/account-management/SET-PROPERTY)
- View user property: [SHOW PROPERTY](../../sql-manual/sql-statements/account-management/SHOW-PROPERTY)
...
From version 2.1.2, support for setting data masking policies for certain columns through Apache Ranger's Data Masking is available, currently only configurable via [Apache Ranger](authorization/ranger).
...
Please refer to [Authorization Scheme Based on Apache Ranger](authorization/ranger).
