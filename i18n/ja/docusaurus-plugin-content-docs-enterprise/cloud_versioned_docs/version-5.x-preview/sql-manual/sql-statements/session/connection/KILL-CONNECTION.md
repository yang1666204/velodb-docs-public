---
{
  ...
  "description": "指定された接続IDの接続を終了します。これにより、この接続に関連付けられたクエリも終了されます。",
  "language": "ja"
}
---
## Description

指定されたコネクションIDのコネクションを切断します。これにより、このコネクションに関連付けられたクエリも停止されます。
...
このSQLコマンドを実行するユーザーは、その接続を所有するユーザーであるか、少なくとも`ADMIN_PRIV`権限を持っている必要があります。
