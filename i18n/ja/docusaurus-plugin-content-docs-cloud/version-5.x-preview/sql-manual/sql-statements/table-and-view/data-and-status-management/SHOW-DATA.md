...
`SHOW DATA`文は、データボリューム、レプリカ数、および行統計に関する情報を表示するために使用されます。この文には以下の機能があります：

- 現在のデータベース内のすべてのテーブルのデータボリュームとレプリカ数を表示できます。
- 指定されたテーブルのマテリアライズドビューのデータボリューム、レプリカ数、および行統計を表示できます。
...
- `FROM`句が指定されない場合（データベースレベル情報の表示）：
