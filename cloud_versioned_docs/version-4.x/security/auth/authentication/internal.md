---
{
    "title": "Built-in Authorization | Authentication",
    "language": "en",
    "description": "In Doris, a useridentity uniquely identifies a user. useridentity consists of two parts: username and host, where username is the username."
}
---
