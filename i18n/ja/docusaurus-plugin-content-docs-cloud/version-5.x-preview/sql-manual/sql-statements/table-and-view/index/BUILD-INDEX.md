...
{
  "title": "BUILD INDEX",
  "description": "Table全体またはTableパーティションのインデックスを構築します。Table名とインデックス名を指定する必要があり、オプションでパーティションリストを指定できます。",
  "language": "ja"
}
---
## 説明

Table全体またはTableパーティションに対してインデックスを構築します。Table名とインデックス名を指定する必要があり、オプションでパーティションリストを指定することができます。
