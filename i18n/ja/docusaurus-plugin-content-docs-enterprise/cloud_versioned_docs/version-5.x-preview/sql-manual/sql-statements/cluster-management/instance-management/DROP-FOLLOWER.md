...
{
  "title": "DROP FOLLOWER",
  "description": "この文は、FRONTENDのFOLLOWERロールを持つノードを削除します。（管理者のみ！）",
  "language": "ja"
}
---
## 説明
...
3. FOLLOWERノードを削除した後、[`SHOW FRONTENDS`](./SHOW-FRONTENDS.md)コマンドで正常に削除されたことを確認してください。
...
1. FOLLOWERノードを削除する
   ...
   ```
このコマンドはクラスター内のFOLLOWERノードを削除します（IP host_ip、ポート9010）
