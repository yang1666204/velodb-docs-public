---
{
  ...
  "description": "この文は、ユーザーが使用権限を持つリソースを表示するために使用されます。一般ユーザーは権限のあるリソースのみを表示できます。",
  "language": "ja"
}
---
## Description
...
3. RESOURCETYPEが指定された場合、対応するResrouceタイプにマッチします。サポートされているRESOURCETYPEsについては[CREATE-RESOURCE](./CREATE-RESOURCE.md)を参照してください
