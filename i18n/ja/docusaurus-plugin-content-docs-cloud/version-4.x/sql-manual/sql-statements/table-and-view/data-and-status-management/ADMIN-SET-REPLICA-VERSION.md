...
- 変更前に元の値を記録してください。変更後は、テーブルの読み取りおよび書き込み操作を確認してください。失敗した場合は、元の値に戻してください。ただし、元に戻す操作も失敗する場合があります。
...
|:-----------|:---------|:---------------------------------------------------------------------------------------------------------------------------------|
| Admin_priv | Database | テーブル、パーティション、システムレベルのコマンドの管理を含む、データベースでの管理操作の実行に必要。 |
