---
{
  ...
  "description": "日時値を指定された週間隔の最も近い値に切り下げます。開始時刻（origin）が提供された場合、",
  "language": "ja"
}
---
# WEEK_FLOOR
...
DATETIME 型の値を返し、切り下げられた日時値を表します。結果の時刻部分は 00:00:00 に設定されます。

**Note:**
- period が指定されていない場合、デフォルトで 1 週間隔になります。
