...
For the time being, read the [Doris metadata design document](https://doris.apache.org/community/design/metadata-design) to understand how Doris metadata works.
