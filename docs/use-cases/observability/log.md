---
{
    "title": "Log Storage and Analysis | Observability",
...
After estimating the resources, you need to deploy the cluster. It is recommended to deploy in both physical and virtual environments manually. For manual deployment, refer to [Manual Deployment](https://doris.apache.org/docs/3.0/install/deploy-manually/integrated-storage-compute-deploy-manually).
...
For more information, refer to [FE Configuration](https://doris.apache.org/docs/3.0/admin-manual/config/fe-config).
...
For more information, refer to [BE Configuration](https://doris.apache.org/docs/3.0/admin-manual/config/be-config).
...
- For data partitioning:
    ...
    - Enable [range partitioning](https://doris.apache.org/docs/3.0/table-design/data-partitioning/manual-partitioning#range-partitioning) (`PARTITION BY RANGE(`ts`)`) with [dynamic partitions](https://doris.apache.org/docs/3.0/table-design/data-partitioning/dynamic-partitioning) (`"dynamic_partition.enable" = "true"`) managed automatically by day.
...
For more information, refer to [Data Partitioning](https://doris.apache.org/docs/3.0/table-design/data-partitioning/auto-partitioning).
...
For more information about the Logstash Doris Output plugin, see [Logstash Doris Output Plugin](https://doris.apache.org/docs/dev/ecosystem/observability/logstash).
...
For more information about Filebeat, refer to [Beats Doris Output Plugin](https://doris.apache.org/docs/dev/ecosystem/observability/beats).
...
For more information about Kafka, see [Routine Load](https://doris.apache.org/docs/3.0/data-operate/import/import-way/routine-load-manual).
...
![WebUI-a log search and analysis interface similar to Kibana](/images/use-cases/observability/WebUI-EN.jpeg)
