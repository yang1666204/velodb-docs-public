...
{
  "title": "QUARTER",
  "description": "この関数は、指定された日付の四半期（1から4）を返します。各四半期は3ヶ月を含みます：",
  "language": "ja"
}
---
## 説明
この関数は指定された日付の四半期（1から4）を返します。各四半期は3ヶ月を含みます：
- Q1: 1月から3月
- Q2: 4月から6月
- Q3: 7月から9月
- Q4: 10月から12月
...
## Return Value
- 入力された日付の四半期を表す1から4の範囲の整数を返します。
- 入力がNULLの場合、関数はNULLを返します。
- 入力が無効な日付（例：0000-00-00）の場合、関数はNULLを返します。
