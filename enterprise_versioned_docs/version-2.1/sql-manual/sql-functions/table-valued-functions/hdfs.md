...
| `read_json_by_line`                         | For JSON format imports, default is `true`                                                                                                   | Reference: JSON Load |
| `strip_outer_array`                         | For JSON format imports, default is `false`                                                                                                  | Reference: JSON Load |
| `json_root`                                 | For JSON format imports, default is empty                                                                                                   | Reference: JSON Load |
| `json_paths`                                | For JSON format imports, default is empty                                                                                                   | Reference: JSON Load |
| `num_as_string`                             | For JSON format imports, default is `false`                                                                                                 | Reference: JSON Load |
| `fuzzy_parse`                               | For JSON format imports, default is `false`                                                                                                 | Reference: JSON Load |
