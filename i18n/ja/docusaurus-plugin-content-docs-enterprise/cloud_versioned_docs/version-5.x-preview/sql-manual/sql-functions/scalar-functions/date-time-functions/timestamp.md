...
この関数は、MySQLの[timestamp function](https://dev.mysql.com/doc/refman/8.4/en/date-and-time-functions.html#function_timestamp)とは異なります。Dorisは現在、datetimeの加算/減算のための2番目の時間パラメータをサポートしていません。
