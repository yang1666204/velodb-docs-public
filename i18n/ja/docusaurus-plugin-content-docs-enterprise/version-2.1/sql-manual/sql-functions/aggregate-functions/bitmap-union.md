...
{
  "title": "BITMAP_UNION",
  "description": "入力Bitmapの和集合を計算し、新しいbitmapを返す",
  "language": "ja"
}
---
## 説明

入力されたBitmapの和集合を計算し、新しいbitmapを返す
...
`TO_BITMAP (expr)`: 0 ～ 18446744073709551615 の符号なしbigintをbitmapに変換
