...
search_dirs = ["cloud_versioned_docs/version-4.x"]
# search_dirs = ["test"]
...
def strip_fenced_code_blocks(md: str) -> str:
    """
    Remove fenced code blocks (``` or ~~~), allowing leading spaces/tabs
    Used ONLY for link detection
    """
    fence_pattern = re.compile(
        ...
        .*?
        \n[ \t]*\2      # closing fence (same indentation allowed)
        """,
