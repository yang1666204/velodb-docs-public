---
{
    ...
    "language": "en",
    "description": "Query circuit breaking is a protective mechanism used to prevent long-running or resource-consuming queries from having a negative impact on the syste..."
}
---
...
Workload Policy can be used to implement circuit breaking for large queries.
