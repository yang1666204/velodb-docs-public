---
{
  ...
  "description": "指定されたマイクロ秒数をdatetime値から減算し、新しいdatetime値を返します。",
  "language": "ja"
}
---
## Description
...
|-----------|--------------------------------------------------|
| `<basetime>`  | 入力される日時値、型はDATETIMEV2    |
| `<delta>`     | 減算するマイクロ秒数、型はINT；1秒 = 1,000,000マイクロ秒 |

## Return Value

DATETIMEV2型の値を返します。入力された日時から指定されたマイクロ秒数を減算した後の時刻値を表します。戻り値の精度は入力パラメータbasetimeと同じです。
