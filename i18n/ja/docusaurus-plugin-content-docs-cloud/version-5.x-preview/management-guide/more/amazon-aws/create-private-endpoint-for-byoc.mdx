...
3. **create endpoint**ボタンをクリックします。
   ...
   3. Service name：サービス名を入力し（Service nameはリージョンによって異なります。[付録](#付録)を参照してください）、**Verify service**をクリックします。サービスが検証に合格すると、Service nameフィールドの下に「Service name verified」というメッセージが表示されます。
