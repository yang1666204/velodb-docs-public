...
すべての内部catalogの下にあるすべてのデータベースのすべてのテーブルのデータサイズ、または指定されたデータベースやテーブルのデータサイズを取得するために使用されます。単位はbyteです。
...
* `db`
    ...
    オプション。指定された場合、指定されたデータベースの下にあるテーブルのデータサイズを取得します。
...
* `single_replica`
    ...
    オプション。指定された場合、テーブルの単一replicaのデータサイズを取得します。
...
2. 指定されたdbの指定されたテーブルのデータサイズ。
    ...
    ```
3. 指定されたデータベースの指定されたテーブルの単一レプリカのデータサイズ。
