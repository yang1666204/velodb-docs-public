...
{
  "title": "YEAR_OF_WEEK",
  "description": "YEAROFWEEK関数は、ISO 8601週カレンダー標準に従って、指定された日付の週年（週の年）を返します。",
  "language": "ja"
}
---
## 説明

YEAR_OF_WEEK関数は、ISO 8601週カレンダー標準に従って、指定された日付の週年（週の年）を返します。通常の年とは異なり、ISO週年は週単位で計算され、年の最初の週は1月4日を含む週であり、その週はその年に属する日を少なくとも4日含む必要があります。

入力日付の年を単純に返す[year function](./year)とは異なり、YEAR_OF_WEEKはISO週カレンダー標準に従います。

詳細については、[ISO Week Date](https://en.wikipedia.org/wiki/ISO_week_date)を参照してください。
...
SMALLINT型を返し、ISO 8601週暦標準に従って計算された週年を表します。
