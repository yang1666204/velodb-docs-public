...
{
  "title": "タスク",
  "description": "Table関数は、タスクの一時テーブルを生成します。",
  "language": "ja"
}
---
## Description

Table関数で、タスクの一時テーブルを生成します。これにより、現在のDorisクラスター内のジョブによって生成されたタスクの情報を表示できます。
...
| Field         | Description                                                                                       |
|---------------|---------------------------------------------------------------------------------------------------|
| **`<type>`**  | タスクのタイプ: <br/> `insert`: insertタイプのタスク。 <br/> `mv`: materialized viewタイプのタスク。 |
