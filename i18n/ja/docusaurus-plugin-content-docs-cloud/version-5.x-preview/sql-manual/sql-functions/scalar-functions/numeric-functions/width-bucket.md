...
{
  "title": "WIDTH_BUCKET",
  "description": "等幅ヒストグラムを構築します。ここでヒストグラムの範囲は等しいサイズの区間に分割され、計算後に、",
  "language": "ja"
}
---
## 説明
...
| -- | -- |
| `<expr>` | ヒストグラムを作成するための式。この式は数値または数値に暗黙的に変換可能な値に評価される必要があります。値の範囲は `-(2^53 - 1)` から `2^53 - 1`（両端を含む）である必要があります |
