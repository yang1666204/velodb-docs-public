...
- Using the **RANDOM** mode or group commit mode is recommended for higher write performance.
...
3. If your queries do not require bucket pruning, use random bucketing and enable the load_to_single_tablet import setting (an import configuration) to reduce compaction write amplification.
