...
デフォルトでは、最大1048576バイト（1MB）をサポートし、最大2147483643バイト（2GB）まで増加させることができます。これは、string_type_length_soft_limit_bytes設定により調整できます。
...
以下のcsvファイルを作成してください：`test_json.csv`
セパレータは、json内のカンマと区別するためにカンマの代わりに`|`を使用します。
