...
{
  "title": "SPLIT_PART",
  "description": "SPLITPART関数は、指定された区切り文字に従って文字列を複数の部分に分割し、そのうちの1つの部分を返します。",
  "language": "ja"
}
---
## 説明

SPLIT_PART関数は、指定された区切り文字に従って文字列を複数の部分に分割し、そのうちの一つの部分を返します。
...
区切り文字に従って分割された文字列の指定された部分を返します。特別なケース：
