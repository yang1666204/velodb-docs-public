...
{
  "title": "MAX_BY",
  "description": "MAXBY関数は、指定された列の最大値に基づいて、関連する値を返します。",
  "language": "ja"
}
---
## Description

MAX_BY関数は、指定されたカラムの最大値に基づいて、関連する値を返します。
...
| -- | -- |
| `<expr1>` | 関連付けられた値の式。サポートする型：Bool、TinyInt、SmallInt、Int、BigInt、LargeInt、Float、Double、Decimal、String、Date、Datetime、Array、Map、Struct |
| `<expr2>` | 最大値の式。サポートする型：Bool、TinyInt、SmallInt、Int、BigInt、LargeInt、Float、Double、Decimal、String、Date、Datetime、Array |
