---
{
    ...
    "language": "en",
    "description": "The Flink Doris Connector is used to read from and write data to a Doris cluster through Flink."
}
---
...
| sink.enable-2pc             | TRUE          | N        | Whether to enable two-phase commit (2pc). The default is true, ensuring Exactly-Once semantics. For details about two-phase commit, refer to [here](../../user-guide/data-operate/import/import-way/stream-load-manual). |
