---
{
  ...
  "description": "MULTISEARCHALLPOSITIONS関数は、文字列内で複数の部分文字列をバッチで検索します。",
  "language": "ja"
}
---
## 説明

MULTI_SEARCH_ALL_POSITIONS関数は、文字列内で複数の部分文字列をバッチで検索します。各部分文字列の最初の出現位置を含む配列を返します。検索は大文字と小文字を区別します。
