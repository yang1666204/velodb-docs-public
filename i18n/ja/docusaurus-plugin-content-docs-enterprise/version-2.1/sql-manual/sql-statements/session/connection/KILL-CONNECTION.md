---
{
  ...
  "description": "指定された接続IDの接続を強制終了します。これにより、この接続に関連付けられたクエリも強制終了されます。",
  "language": "ja"
}
---
## 説明

指定された接続IDの接続を終了します。この操作により、この接続に関連付けられたクエリも終了されます。
...
> コネクションのIDです。SHOW PROCESSLIST文を通じて照会できます。

## アクセス制御要件

このSQLコマンドを実行するユーザーは、コネクションを所有するユーザーであるか、少なくとも`ADMIN_PRIV`権限を持っている必要があります。
