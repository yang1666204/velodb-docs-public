---
{
  ...
  "description": "KURTOSIS関数はデータの尖度を計算します。使用される数式は次のとおりです：4次中心モーメント / (分散の2乗) - 3。",
  "language": "ja"
}
---
## 説明

KURTOSIS関数は、データの[尖度](https://en.wikipedia.org/wiki/Kurtosis)を計算します。使用される公式は次の通りです：4次中心モーメント / (分散の2乗) - 3。
