...
{
  "title": "ARRAY_EXCEPT",
  "description": "array1の要素のうちarray2に含まれない要素を重複なしで配列として返します。入力パラメータがnullの場合、nullが返されます。",
  "language": "ja"
}
---
## 説明
array1の要素のうちarray2には含まれていない要素を、重複を除いて配列として返します。入力パラメータがnullの場合、nullが返されます。
