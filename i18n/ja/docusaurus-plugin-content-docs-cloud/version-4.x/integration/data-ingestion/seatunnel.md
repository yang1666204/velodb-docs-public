...
2相コミット（2pc）を有効にするかどうか。デフォルトはtrueで、Exactly-Onceセマンティクスを保証します。2相コミットについては、[こちら](../../user-guide/data-operate/import/import-way/stream-load-manual)を参照してください。
...
stream loadの`data_desc`パラメーター。詳細はこちらのリンクで確認できます：
...
[その他のStream Loadパラメータ設定](../../user-guide/data-operate/import/import-way/stream-load-manual)
