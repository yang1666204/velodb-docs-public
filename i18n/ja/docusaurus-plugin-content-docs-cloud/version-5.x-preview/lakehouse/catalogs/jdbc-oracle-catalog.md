---
{
  ...
  "description": "Apache Doris JDBC Catalog は、標準の JDBC インターフェースを通じて Oracle データベースへの接続をサポートしています。",
  "language": "ja"
}
---
...
1. Oracle Catalogの作成やクエリ時に`ONS configuration failed`が発生する

   be.confのJAVA\_OPTSに-Doracle.jdbc.fanEnabled=falseを追加し、ドライバを<https://repo1.maven.org/maven2/com/oracle/database/jdbc/ojdbc8/19.23.0.0/ojdbc8-19.23.0.0.jar>にアップグレードしてください

2. Oracle Catalogの作成やクエリ時に`Non supported character set (add orai18n.jar in your classpath): ZHS16GBK`例外が発生する
