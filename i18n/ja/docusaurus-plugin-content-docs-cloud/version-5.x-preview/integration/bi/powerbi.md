...
{
  "title": "Power BI",
  "description": "Power BIは、Excel、SQL サーバー、Azure...を含む複数のデータソースに接続できるソフトウェアサービスとアプリケーションコネクターのコレクションです。",
  "language": "ja"
}
---
# Power BI
...
2. 必要に応じて4つのTableを同じ画面にドラッグアンドドロップで配置し、関連するフィールドをドラッグアンドドロップしてください。
...
6. `region`Tableから`r_name`フィールドを列Xにドラッグしてください。
