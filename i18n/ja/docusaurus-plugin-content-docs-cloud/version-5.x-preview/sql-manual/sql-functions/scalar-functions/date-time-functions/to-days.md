...
---
## 説明
日付を日数を表す数値に変換する日付計算関数で、基準日（`0000-00-00`）から指定された日付までの合計日数を計算します

この関数はMySQLの[to_days function](https://dev.mysql.com/doc/refman/8.4/en/date-and-time-functions.html#function_to-days)と一致した動作をします。
