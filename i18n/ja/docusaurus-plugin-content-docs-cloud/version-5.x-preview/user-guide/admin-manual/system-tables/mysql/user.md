...
| max_user_connections                   | bigint         | 許可される最大接続数。                              |
...
| password_policy.history_num            | varchar(32)    | 履歴パスワードの数。                                |
| password_policy.history_passwords      | varchar(65533) | 履歴パスワード。                                    |
| password_policy.num_failed_login       | varchar(32)    | 連続ログイン失敗の許可回数。                        |
| password_policy.password_lock_seconds  | varchar(32)    | ロック発動後のパスワードロック時間。                |
| password_policy.failed_login_counter   | varchar(32)    | ログイン失敗カウント。                              |
