---
{
    ...
    "language": "en",
    "description": "Doris provides auditing capabilities for database operations, allowing the recording of user logins, queries, and modification operations on the datab..."
}
---
...
Starting from Doris version 2.1, Doris can write user behavior operations to the audit_log table in the `__internal_schema` database by enabling the audit log feature.
