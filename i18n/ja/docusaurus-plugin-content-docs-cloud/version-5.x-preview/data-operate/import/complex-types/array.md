...
{
  "title": "ARRAY | 複合型",
  "description": "ARRAY<T> T型アイテムの配列です。詳細はARRAYをクリックしてください。",
  "language": "ja"
}
---
# ARRAY

`ARRAY<T>` T型項目の配列です。詳細については[ARRAY](../../../sql-manual/basic-element/sql-data-types/semi-structured/ARRAY.md)をクリックしてください。
