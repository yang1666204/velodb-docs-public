---
{
    ...
    "description": "Observability refers to the ability to infer a system's internal state through its external output data."
}
---
...
![doris-observabiltiy-architecture](/images/use-cases/observability/observability-architecture-doris.png)
...
<br />
<iframe width="951" height="466" src="https://www.youtube.com/embed/LrR4SNyAlg8?si=vnrJTP1z_Sv03xKX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- **Log**
	![log-visualization](/images/use-cases/observability/log-visualization.png)

- **Trace**
	![log-visualization](/images/use-cases/observability/trace-visualization.png)

- **Metrics**
	![metrics-visualization](/images/use-cases/observability/metrics-visualization.png)
...
![studio-visualization](/images/use-cases/observability/studio-discover.jpeg)
