...
Hiveに加えて、多くの他のシステムがメタデータの保存にHive Metastoreを使用しています。そのため、Hive Catalogを通じて、HiveTableだけでなく、IcebergやHudiなどのHive Metastoreをメタデータストレージに使用する他のTable形式にもアクセスできます。
