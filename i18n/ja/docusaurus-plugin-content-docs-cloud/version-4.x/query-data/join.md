...
![パーティション Shuffle Join](/images/cloud/user-guide/query-data/partition-shuffle-join.jpg)
...
![バケット Shuffle Join](/images/cloud/user-guide/query-data/bucket-shuffle-join.png)
