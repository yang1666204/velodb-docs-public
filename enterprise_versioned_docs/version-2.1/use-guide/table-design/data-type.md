...
| ---------------------------------------------------------- | --------------- | ------------------------------------------------------------ |  
| BOOLEAN       | 1               | Boolean data type that stores only two values: 0 represents false, 1 represents true. |  
| TINYINT       | 1               | Integer value, signed range is from -128 to 127.                 |  
| SMALLINT     | 2               | Integer value, signed range is from -32768 to 32767.             |  
| INT               | 4               | Integer value, signed range is from -2147483648 to 2147483647.   |  
| BIGINT         | 8               | Integer value, signed range is from -9223372036854775808 to 9223372036854775807. |  
| LARGEINT     | 16              | Integer value, range is [-2^127 + 1 to 2^127 - 1].               |  
| FLOAT           | 4               | Single precision floating point number, range is [-3.4 * 10^38 to 3.4 * 10^38]. |  
| DOUBLE         | 8               | Double precision floating point number, range is [-1.79 * 10^308 to 1.79 * 10^308]. |  
...
| Type Name                                                    | Storage (bytes) | Description                                                  |  
| ---------------------------------------------------------- | --------------- | ------------------------------------------------------------ |  
| IPv4                 | 4               | It is used in conjunction with the `ipv4_*` family of functions. |  
| IPv6                 | 16              | It is used in conjunction with the `ipv6_*` family of functions. |
