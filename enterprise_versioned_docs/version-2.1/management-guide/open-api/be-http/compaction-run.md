...
* `compact_type`
    - The value is `base` or `cumulative` or `full`. For usage scenarios of full_compaction, please refer to [Data Recovery](../../../admin-manual/trouble-shooting/repairing-data).
