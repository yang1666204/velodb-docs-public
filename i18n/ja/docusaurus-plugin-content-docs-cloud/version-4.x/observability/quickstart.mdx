...
{
  "title": "クイックスタート",
  "description": "VeloDBを活用した完全なオブザーバビリティスタック（ログ、トレース、メトリクス）を5分で体験する",
  "language": "ja"
}
---
# オブザーバビリティ クイックスタート
...
データベースと`otel_logs`Tableを選択してください。時系列でのログボリュームのヒストグラムが表示されます：
...
**さらに詳しく知りたいですか？**アーキテクチャの詳細と本番環境デプロイメントガイドについては[オブザーバビリティ 概要](./overview)をご確認ください。
...
- [オブザーバビリティ 概要](./overview) - オブザーバビリティにおけるVeloDBの必要性
- [VARIANT Data タイプ](../../sql-manual/basic-element/sql-data-types/semi-structured/VARIANT) - ログとトレース用の半構造化データ型
