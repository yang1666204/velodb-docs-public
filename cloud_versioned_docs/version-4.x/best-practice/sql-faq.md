---
{
    "title": "SQL Error",
    "language": "en",
    "description": "After executing certain statements such as show backends/frontends, some columns may be found to be incomplete in the results."
}
---
...
To ensure that the data sequence between different replicas is unique, you can refer to the [Sequence Column](../user-guide/data-modification/update/update-of-unique-model) function.
