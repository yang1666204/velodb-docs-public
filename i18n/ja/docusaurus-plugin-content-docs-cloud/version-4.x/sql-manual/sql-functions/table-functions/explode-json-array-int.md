---
{
  ...
  "description": "explodejsonarrayint Table関数は、各要素が整数型の JSON 配列を受け取ります。",
  "language": "ja"
}
---
## 説明

`explode_json_array_int`Table関数は、各要素が整数型のJSON配列を受け取り、配列内の各整数を複数行に展開します。各行には1つの整数が含まれます。LATERAL VIEWと組み合わせて使用されます。
