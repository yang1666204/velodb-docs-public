...
## 例
sales という名前のテーブルがあり、営業担当者名（sales_person）、売上金額（sales_amount）、売上日（sales_date）を含む売上データが格納されているとします。各売上日における各営業担当者の売上金額の累積パーセンテージを計算したいとします。
