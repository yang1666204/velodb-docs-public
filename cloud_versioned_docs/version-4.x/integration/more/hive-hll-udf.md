...
# Hive HLL UDF
 ...
 The Hive HLL UDF provides a set of UDFs for generating HLL operations in Hive tables, which are identical to Doris HLL. Hive HLL can be imported into Doris through Spark HLL Load. For more information about HLL, please refer to Using HLL for Approximate Deduplication.:[Approximate Deduplication Using HLL](../../user-guide/data-operate/import/complex-types/hll)
...
2. [Create a Doris catalog](../../user-guide/lakehouse/catalogs/hive-catalog)
