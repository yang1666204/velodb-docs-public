...
> table_valued_function、テーブル値関数の名前（CATALOGSなど）。サポートされているテーブル値関数の一覧については、「[Table-Valued Functions](https://doris.apache.org/docs/dev/lakehouse/file-analysis)」セクションを参照してください
