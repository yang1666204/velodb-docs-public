---
{
  ...
  "description": "Dorisは、PostgreSQLに格納されたメタデータを使用してLakeSoulテーブルデータへのアクセスと読み取りをサポートしています。",
  "language": "ja"
}
---
:::warning Note!
...
* `[CommonProperties]`
  ...
  CommonPropertiesセクションは、一般的なプロパティを設定するためのものです。「Common Properties」セクションの[Data Catalog Overview](../catalog-overview.md)を参照してください。
...
- LakeSoul MOR（Merge-On-Read）テーブルの読み込みをサポートします。
