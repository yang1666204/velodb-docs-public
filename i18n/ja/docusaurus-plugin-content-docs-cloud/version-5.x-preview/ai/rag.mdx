...
- [Vector Search 概要](/cloud/5.x-preview/ai/vector-search/overview)
- [Text Search 概要](/cloud/5.x-preview/ai/text-search/overview)
- [Cosine Distance ファンクション](/cloud/5.x-preview/sql-manual/sql-functions/ai-functions/distance-functions/cosine-distance)
