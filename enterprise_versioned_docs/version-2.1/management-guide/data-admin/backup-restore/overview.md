...
3. **Tables with Storage Policies Not Supported**:
   Tables that use [**storage policies**](https://docs.velodb.io/cloud/4.x/user-guide/table-design/tiered-storage/remote-storage) **do not support** backup and restore operations.
