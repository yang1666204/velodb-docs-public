...
VeloDBウェアハウスで、左サイドバーの**Development**の下にある**Data**セクションに移動し、**カタログs**をクリックします。

**Add 外部カタログ**ボタンがあるカタログsページが表示されます。

![カタログs Page](/images/cloud/integration/aws-glue/03-catalogs-page.png)

## ステップ2: 外部カタログを追加する

**Add 外部カタログ**をクリックして、利用可能なカタログタイプを表示します。

![Add 外部カタログ Options](/images/cloud/integration/aws-glue/04-add-external-catalog-options.png)
...
| フィールド | 説明 |
|-------|-------------|
| **認証 タイプ** | `Access Key`または`IAM Role` |
...
![カタログ Created Successfully](/images/cloud/integration/aws-glue/10-glue-catalog-created-success.png)
