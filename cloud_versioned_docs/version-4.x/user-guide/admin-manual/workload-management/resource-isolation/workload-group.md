---
{
    ...
    "language": "en",
    "description": "Workload Group is an in-process mechanism for isolating workloads."
}
---
...
The CPU limit configured at this point is a soft limit. Doris will automatically create a group named normal, which cannot be deleted.
...
* This is usually caused by the following reasons:
    ...
    * The CPU usage of the Doris BE process is higher than the CPU hard limit configured for the Workload Group.
      ...
      This table only records the CPU usage of the Workload Group and has been supported.
