...
ビジネスインテリジェンス製品として、FineBIはデータ処理、リアルタイム分析、多次元分析Dashboardなどの機能を持つシステムアーキテクチャを備えています。FineBIは豊富なデータソース接続と複数のビューを持つテーブルの分析と管理をサポートしています。FineBIはApache Dorisの内部および外部データのモデリングと可視化を正常にサポートできます。
...
2. 既存のデータベース接続内のテーブルをインポートする必要があります
