...
- 右TableのDistribute Typeを指定することができ、`[shuffle]`または`[broadcast]`のいずれかを指定でき、Joinの右Tableの前に記述する必要があります。
...
**Ordered Hintとの組み合わせでの使用**

Join順序をテキスト順序に固定し、その後Joinに期待されるDistribute方法を指定します。例えば：
