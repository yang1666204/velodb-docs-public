...
---
Kudu CatalogはKudu Connectorを通じてKuduTableにアクセスするために[Trino Connector](https://doris.apache.org/zh-CN/community/how-to-contribute/trino-connector-developer-guide/)互換フレームワークを使用します。
