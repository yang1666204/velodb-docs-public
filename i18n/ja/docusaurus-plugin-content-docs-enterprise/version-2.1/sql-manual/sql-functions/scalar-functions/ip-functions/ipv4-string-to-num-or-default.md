---
{
  ...
  "description": "IPv4アドレスをA.B.C.D形式（10進数をドット区切りで表記）で含む文字列を受け取ります。",
  "language": "ja"
}
---
## 説明
A.B.C.D形式（10進数のドット区切り）のIPv4アドレスを含む文字列を受け取ります。対応するIPv4アドレスをビッグエンディアンで表現したBIGINT数値を返します。
...
## Return Value
対応するIPv4アドレスをビッグエンディアンで表すBIGINT数値を返します。
