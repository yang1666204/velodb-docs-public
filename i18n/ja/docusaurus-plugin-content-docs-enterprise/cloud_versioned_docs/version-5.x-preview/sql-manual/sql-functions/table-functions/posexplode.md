...
---
## 説明
`posexplode`テーブル関数は`<array>`列を複数行に展開し、位置を示す列を追加して、[`STRUCT`](../../basic-element/sql-data-types/semi-structured/STRUCT.md)型を返します。
...
1. 0から開始し、1ずつ増分し、n – 1まで続く整数の列。nは結果行数を表します。
2. `<array>`のすべての要素を含む列。
