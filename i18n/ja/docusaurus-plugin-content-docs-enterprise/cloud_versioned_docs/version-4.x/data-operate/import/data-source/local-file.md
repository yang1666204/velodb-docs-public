...
{
  "title": "ローカルファイル",
  "description": "Dorisは、ローカルソースからデータを読み込む複数の方法を提供します：",
  "language": "ja"
}
---
...
Dorisは MySQL プロトコルと互換性があり、標準の[LOAD DATA](https://dev.mysql.com/doc/refman/8.0/en/load-data.html)構文を使用してローカルファイルを読み込むことをサポートしており、CSVファイルの読み込みに適しています。
