...
この文は非同期マテリアライズドビューを変更するために使用されます。
...
```
I notice that the text you provided is just "##### REPLACE" which appears to be a markdown header placeholder rather than actual technical documentation content to translate.
...
```
例えば、mv2をmv1に名前を変更し、元のmv1を削除したい場合
