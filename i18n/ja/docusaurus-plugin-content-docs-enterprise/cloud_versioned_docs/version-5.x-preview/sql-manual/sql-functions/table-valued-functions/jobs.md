...
{
  "title": "JOBS",
  "description": "Table関数は、一時的なタスクテーブルを生成し、特定のタスクタイプのジョブ情報を表示することができます。",
  "language": "ja"
}
---
## 概要

一時的なタスクテーブルを生成するテーブル関数で、特定のタスクタイプのジョブ情報を表示することができます。
...
| Field         | Description                                                                                   |
|---------------|-----------------------------------------------------------------------------------------------|
| **`<type>`**  | ジョブの種類: <br/> `insert`: Insert into typeジョブ。 <br/> `mv`: Materialized viewジョブ。 |



## 戻り値

-  **`jobs("type"="insert")`** insert種類のジョブの戻り値
