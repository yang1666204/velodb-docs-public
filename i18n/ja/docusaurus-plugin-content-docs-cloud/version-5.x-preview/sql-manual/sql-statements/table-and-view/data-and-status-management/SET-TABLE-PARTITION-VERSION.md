...
1. FEメタデータ内のpartition_id 10075を持つパーティションのバージョンを100に設定します。
...
1. パーティションバージョンを設定する前に、BEマシン上の実際のreplicaのバージョンを確認する必要があります。このコマンドは一般的に緊急時の障害復旧でのみ使用されます。慎重に操作してください。
2. このコマンドはstorage-computing separation modeではサポートされていません。設定しても有効になりません。
