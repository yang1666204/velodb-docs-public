---
{
  ...
  "description": "Workload Groupリソースの使用状況情報を保存します。",
  "language": "ja"
}
---
...
| LOCAL_SCAN_BYTES_PER_SECOND  | bigint | ローカルスキャンのデータレート（バイト毎秒） |
| REMOTE_SCAN_BYTES_PER_SECOND | bigint | リモートスキャンのデータレート（バイト毎秒） |
