...
{
  "title": "HOUR_FLOOR",
  "description": "hourfloor関数は、入力されたdatetime値を指定された時間間隔の最も近い時刻まで切り下げます。例えば、間隔が5時間の場合、",
  "language": "ja"
}
---
## 説明

hour_floor関数は、入力されたdatetime値を指定された時間間隔の最も近い時刻まで切り下げます。例えば、間隔が5時間の場合、この関数は入力時刻をその間隔内の開始時刻マークに調整します。
