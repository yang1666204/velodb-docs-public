...
{
  "title": "BACKEND を追加",
  "description": "ADD BACKENDは、Dorisクラスターに1つ以上のBEノードを追加するために使用されます。",
  "language": "ja"
}
---
## Description
...
2. Resource Groupを使用することで、クラスター内のBEノードをより適切に管理および整理できます。
...
4. クラスターの可用性と耐障害性を向上させるために、異なる物理的な場所やラックにBEノードを追加することを検討してください。
5. 新しく追加されたBEノードが適切に利用されるように、クラスター内の負荷を定期的にチェックし、バランスを取ってください。
