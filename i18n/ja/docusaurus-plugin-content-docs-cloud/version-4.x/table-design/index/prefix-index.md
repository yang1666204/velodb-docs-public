...
1. 高速化クエリが必要な列に転置インデックスを作成する。Tableには多くの転置インデックスを持つことができます。
2. DUPLICATETableの場合、列順序を調整した対応する強一貫性マテリアライズドビューを作成することで、間接的にマルチプレフィックスインデックスを実現できます。詳細については、クエリ高速化/マテリアライズドビューを参照してください。
