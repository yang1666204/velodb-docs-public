---
{
    ...
    "language": "en",
    "description": "The DataX Doriswriter plugin supports synchronizing data from various data sources, such as MySQL, Oracle, and SQL Server, into Doris using the Stream..."
}
---
...
* **loadProps**
  ...
  - Description: The request parameter of StreamLoad. For details, refer to the StreamLoad introduction page. [Stream load - Apache Doris](../../user-guide/data-operate/import/import-way/stream-load-manual)
...
>4. For more parameters of Stream load, please refer to [Stream load - Apache Doris](../../user-guide/data-operate/import/import-way/stream-load-manual)
