...
+---------------------------------------------------------------------------------------------+
```
Insert とテストケース。このテストケースのセットでは、元の文字列、パターン、置換文字列を格納するTableを作成します。次に、様々なテストデータを挿入し、対応するパターンと置換文字列を使用して元の文字列に対してREGEXP_REPLACE操作を実行します。最後に、置換された文字列を取得して表示します。
