---
{
  ...
  "description": "データベース下のすべてのカスタム関数とシステム提供関数を表示します。",
  "language": "ja"
}
---
## デスクリプション

データベース内のすべてのカスタム関数およびシステム提供関数を表示します。
...
| Column | デスクリプション         |
| -- |------------|
| Signature | 関数名とパラメータタイプ   |
| Return Type | 関数によって返される値のデータタイプ |
| ファンクション Type | 関数のタイプ      |
| Intermediate Type | 中間結果タイプ     |
...
| Privilege  | Object   | 注釈       |
|:--------------|:---------|:--------------|
| SHOW_PRIV    | ファンクション | この関数に対してshow権限を持つ必要があります |
