...
| CPU_SHARE                      | bigint       | Workload GroupのCPUソフト制限の重み              |
...
| MAX_REMOTE_SCAN_THREAD_NUM     | bigint       | リモートスキャンスレッドプール内の最大スレッド数     |
| MIN_REMOTE_SCAN_THREAD_NUM     | bigint       | リモートスキャンスレッドプール内の最小スレッド数     |
| SPILL_THRESHOLD_LOW_WATERMARK  | varchar(256) | Workload Groupのディスクスピルの低水準点           |
| SPILL_THRESHOLD_HIGH_WATERMARK | varchar(256) | Workload Groupのディスクスピルの高水準点          |
