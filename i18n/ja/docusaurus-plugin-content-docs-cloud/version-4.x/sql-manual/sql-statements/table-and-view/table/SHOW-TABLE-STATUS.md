...
| Rows                | String   | テーブルの行数。非トランザクショナルテーブルの場合、この値は正確で、トランザクショナルエンジンの場合、この値は通常推定値です。                                                                               |
...
| Create_options      | String   | テーブル作成時のその他すべてのオプションを指します                                                                                     |
