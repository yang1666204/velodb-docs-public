...
この関数は、指定された日付が属する四半期（1から4）を返します。各四半期は3か月で構成されます：
- 第1四半期：1月から3月
- 第2四半期：4月から6月
- 第3四半期：7月から9月
- 第4四半期：10月から12月
...
| --------- | ----------- |
| `<date_or_time_expr>` | 入力する日付または日時の値。date/datetimeタイプをサポートします。特定のdatetimeおよびdate形式については、[datetime conversion](../../../../sql-manual/basic-element/sql-data-types/conversion/datetime-conversion)および[date conversion](../../../../sql-manual/basic-element/sql-data-types/conversion/date-conversion)を参照してください。 |

## Return Value

- 入力された日付が属する四半期を表すTINYINTを返します。範囲は1から4です。
- 入力値がNULLの場合、この関数はNULLを返します。
