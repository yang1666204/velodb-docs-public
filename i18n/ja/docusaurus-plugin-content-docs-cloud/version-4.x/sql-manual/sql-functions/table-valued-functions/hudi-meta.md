...
{
  "title": "HUDI_META",
  "description": "hudimeta table-valued-function(tvf)は、hudiメタデータ、操作履歴、Tableのtimeline、instantの状態などを読み取るために使用されます。",
  "language": "ja"
}
---
## デスクリプション
...
```
## 必須パラメータ
`hudi_meta`Table関数（tvf）の各パラメータは`"key"="value"`ペアです。
