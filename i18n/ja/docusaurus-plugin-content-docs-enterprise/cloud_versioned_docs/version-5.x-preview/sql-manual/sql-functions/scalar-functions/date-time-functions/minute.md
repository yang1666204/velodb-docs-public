...
{
  "title": "MINUTE",
  "description": "MINUTE関数は、入力されたdatetime値から分の構成要素を抽出し、0から59までの範囲の整数を返します。",
  "language": "ja"
}
---
## 説明

MINUTE関数は、入力されたdatetime値から分の要素を抽出し、0から59の範囲の整数を返します。この関数は、DATE、DATETIME、およびTIME型の処理をサポートしています。
