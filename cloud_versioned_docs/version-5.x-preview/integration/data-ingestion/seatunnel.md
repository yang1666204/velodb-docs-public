---
{
    ...
    "description": "SeaTunnel is a very easy-to-use ultra-high-performance distributed data integration platform that supports real-time synchronization of massive data."
}
---
...
Whether to enable two-phase commit (2pc), the default is true, to ensure Exactly-Once semantics. For two-phase commit, please refer to [here](../../user-guide/data-operate/import/import-way/stream-load-manual).
...
[More Stream Load parameters](../../user-guide/data-operate/import/import-way/stream-load-manual)
...
[More Stream Load parameter configuration](../../user-guide/data-operate/import/import-way/stream-load-manual)
...
[More Doris stream_load Configurations](../../user-guide/data-operate/import/import-way/stream-load-manual)
