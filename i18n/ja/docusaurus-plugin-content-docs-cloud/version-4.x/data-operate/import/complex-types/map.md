...
{
  "title": "MAP | 複合型",
  "description": "MAP<K, V> K、Vアイテムのマップで、キー列として使用することはできません。現在MAPはDuplicateおよびUnique Model Tablesでのみ使用可能です。",
  "language": "ja"
}
---
# MAP

`MAP<K, V>` K、Vアイテムのマップです。キー列として使用することはできません。現在、MAPはDuplicateおよびUnique Model Tablesでのみ使用できます。
