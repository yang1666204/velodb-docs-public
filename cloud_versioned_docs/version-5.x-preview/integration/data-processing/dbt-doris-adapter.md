---
{
    ...
    "language": "en",
    "description": "DBT(Data Build Tool) is a component that focuses on doing T (Transform) in ELT (extraction, loading, transformation) - the \"transformation data\" link..."
}
---
