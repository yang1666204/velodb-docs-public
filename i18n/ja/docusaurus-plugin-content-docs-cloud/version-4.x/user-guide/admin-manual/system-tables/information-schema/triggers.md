...
{
  "title": "triggers",
  "description": "MySQL互換の、互換性のための常に空のトリガーテーブル。Dorisのトリガーサポートは反映されません。",
  "language": "ja"
}
---
# triggers
...
| TABLE_TYPE      | varchar(64)   | テーブルのタイプ。SYSTEM VIEW、VIEW、BASE TABLEを含む        |
| ENGINE          | varchar(64)   | テーブルのストレージエンジンタイプ                           |
| VERSION         | bigint        | 無効な値                                                     |
| ROW_FORMAT      | varchar(10)   | 無効な値                                                     |
| TABLE_ROWS      | bigint        | テーブル内の推定行数                                         |
...
| TABLE_COMMENT   | varchar(2048) | テーブルに関するコメント                                     |
