...
6. cluster_balance : To check the balance of the cluster, please refer to Data Copy Management
...
8. colocation_group : This command can view the existing Group information in the cluster. For details, please refer to the Colocation Join chapter
