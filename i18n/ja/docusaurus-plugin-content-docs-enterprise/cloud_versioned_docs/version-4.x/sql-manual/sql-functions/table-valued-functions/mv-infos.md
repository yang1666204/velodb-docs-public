...
{
  "title": "MV_INFOS",
  "description": "Table関数、非同期マテリアライズドビューの一時テーブル生成",
  "language": "ja"
}
---
## Description

非同期マテリアライズドビューのための一時テーブルを生成するテーブル関数で、特定のデータベース内に作成された非同期マテリアライズドビューに関する情報を表示できます。
...
| SyncWithBaseTables     | BOOLEAN | ベーステーブルとデータが同期されているかどうか。どのパーティションが同期されていないかを確認するには、[SHOW PARTITIONS](../../sql-statements/table-and-view/table/SHOW-PARTITIONS)を使用してください |
