...
{
  "title": "COALESCE",
  "description": "引数リストから最初の非null式を左から右へ評価して返します。すべての引数がNULLの場合、NULLを返します。",
  "language": "ja"
}
---
## 説明
...
## 使用上の注意
1. 複数の引数の型はできるだけ一貫している必要があります。
2. 複数の引数の型が一貫していない場合、関数は同じ型への変換を試みます。変換ルールについては次を参照してください: [Type Conversion](../../../basic-element/sql-data-types/conversion/overview.md)
