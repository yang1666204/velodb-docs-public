...
{
  "title": "HUDI_META",
  "description": "hudimeta table-valued-function(tvf)は、hudiメタデータ、操作履歴、テーブルのtimeline、instantの状態などを読み取るために使用されます。",
  "language": "ja"
}
---
## Description

hudi_meta table-valued-function(tvf)は、hudiメタデータ、操作履歴、テーブルのtimeline、instantの状態などを読み取るために使用されます。
...
- timelineのhudiテーブル形式メタデータを読み取り、アクセスします。
